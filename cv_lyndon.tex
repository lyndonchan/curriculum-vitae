...
\begin{ditem}
	...
	\begin{ditem}
		\item \textsc{CVPR 2018} (Dec. 2017): proposed novel CNN architecture with fixed-basis kernels (rejected)
...
\begin{ditem}
	\item \textsc{Research Interests:} Computer Vision, Computer-aided Diagnosis (CADx), Intelligence Amplification (IA), Abnormality Detection, Weakly-Supervised Semantic Segmentation (WSSS)
	\item \textsc{Other Interests:} Coding useful tools, Blogging, Teaching, Podcasting, Reading (history, philosophy), Music, Cooking, Translation, Hiking, Running, Swimming
\end{ditem}
